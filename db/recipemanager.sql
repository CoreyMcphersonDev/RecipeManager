...
REPLACE INTO `mealhistory` (`mealhistory_id`, `recipe_id`, `tasterating_id`, `meal_made_date`) VALUES
	(1, 2, 3, '2017-01-01'),
	(2, 5, 4, '2017-01-02'),
	(3, 5, 4, '2017-01-03'),
	(4, 5, 4, '2017-01-04'),
...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  `recipe_source` varchar(100) DEFAULT NULL,
...
REPLACE INTO `recipe` (`recipe_id`, `recipe_name`, `recipe_timetocook_minutes`, `recipe_timetoprep_minutes`, `totaltime`, `serves`, `photo`, `photo_path`, `recipe_instructions`, `recipe_source`, `foodartist_id`, `recipecategory_id`, `recipecuisine_id`, `difficultyrating_id`) VALUES
	...
	(10, 'Vegan Alfredo', 10, 30, 40, 4, NULL, NULL, 'Add pasta to a large pot of boiling, well-salted water and cook according to package instructions. Drain and cover to prevent drying.', 'https://minimalistbaker.com/30-minute-vegan-alfredo-vegan-gf/', NULL, 1, 2, 2),
	(11, 'Curry Bowls', 10, 30, 40, 2, NULL, NULL, 'Preheat oven to 375 degrees F (190 C) and line a large baking sheet with parchment paper.', 'https://minimalistbaker.com/curry-roasted-vegetable-lentil-kale-salad/', NULL, 1, 5, 1),
	(12, 'Vegetarian Tortilla Soup', 30, 20, 50, 8, NULL, NULL, 'Spray large nonstick saucepan with vegetable oil spray. Add onion and garlic; cover and cook over medium-low heat until almost tender, stirring often, about 5 minutes. Stir in tomato paste, cumin and chili powder. Add broth and 2 tablespoons cilantro; bring to boil. Reduce heat; cover and simmer until flavors blend, about 15 minutes. (Can be made 1 day ahead. Cover; chill. Bring to simmer before continuing.)', 'http://cookieandkate.com/2013/vegetarian-tortilla-soup/', NULL, 1, 4, 1),
	(13, 'Tofu Scramble', 15, 20, 35, 4, NULL, NULL, 'Pat tofu dry and roll in a clean, absorbent towel with something heavy on top, such as a cast-iron skillet, for 15 minutes.', 'https://minimalistbaker.com/southwest-tofu-scramble/', NULL, 2, 1, 1),
	...
	(16, '1 Bowl Vegan Chocolate Cake', 30, 15, 45, 10, NULL, NULL, 'Preheat oven to 350 degrees F (176 C) and lightly spray 2 8-inch round cake pans or 1 large rectangular pan with nonstick spray (see notes for cooking times for different size pans). Dust with cocoa powder, shake out the excess and set aside.', 'https://minimalistbaker.com/one-bowl-vegan-chocolate-cake/', NULL, 4, 1, 1),
	(17, 'Simple Apple Crisp', 50, 15, 65, 8, NULL, NULL, 'Preheat oven to 375 degrees F (190 C) and lightly grease a 9x9 baking dish.', 'http://cookieandkate.com/2014/healthy-gluten-free-apple-crisp/', NULL, 4, 1, 2),
	(18, 'Spicy Red Lentil Curry', 25, 10, 35, 2, NULL, NULL, 'Thoroughly rinse lentils in a fine mesh strainer and set aside. If serving with brown rice, cook at this time using this method from Saveur.', 'https://minimalistbaker.com/spicy-red-lentil-curry/', NULL, 1, 5, 1),
	...
	(20, 'New York Style Pizza Crust', 15, 60, 75, 8, NULL, NULL, 'Combine water and sugar in small bowl; stir to dissolve sugar.', 'http://www.food.com/recipe/new-york-style-pizza-crust-15194', NULL, 6, 1, 2),
	(21, 'Dinner Rolls', 15, 90, 105, 12, NULL, NULL, 'In a large bowl combine warm water with yeast and 1 teaspoon sugar. Set aside for 5-10 minutes.', NULL, NULL, 6, 1, 2),
	...
	(23, 'Vegetarian West African Peanut Soup', 35, 10, 45, 4, NULL, NULL, 'In a medium Dutch oven or stock pot, bring the broth to a boil. Add the onion, ginger, garlic and salt. Cook on medium-low heat for 20 minutes.', 'http://cookieandkate.com/2013/west-african-peanut-soup/', NULL, 1, 7, 1),
