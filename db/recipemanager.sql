...
-- Dumping data for table recipewizard.foodartist: ~10 rows (approximately)
...
REPLACE INTO `foodartist` (`foodArtistId`, `foodArtistUserName`, `firstName`, `lastName`, `password`, `salt`) VALUES
	...
	(2, 'siggy', 'sigurd', 'siggurdsson', '�B~a#!�ȿ���c�}Zz��:Sl��', '�Q�t�+5.�pP!���'),
	(3, 'corey', 'corey', 'm', '� r�k����@� u����C4���', '$%圎.�\'8������'),
	(4, 'test', 'testy', 'mcghee', '����`��Ӛ�F�& �#\0��](��', '\'��d�@䵥��'),
	(6, 'corey', 'corey', 'm', 'RW�8E�/�9���f:�!�ِʖ�<���', '^,w��(o�S*�]s8��'),
	(7, 'louis', 'louis', 'f', 'O�};#)*��:��n��EUl|0�B�\'�', 'c���0D���i�hL�d'),
	(8, 'krisgiraffe', 'kristen', 's', 'X��l�����y����f}:���Bl��j.�+', 'M��.[r})�\r,�.3�'),
	(9, 'coreycorey', 'corey', 'test', '9+KN��\'�X���`�+�P\n�H�E�ͻ��T�Y', '@$j�kY0@����7�('),
	(10, 'test2', 'corey11111', 'sadlfjad;sljf', '�F"G_���̪iO���&���1u��݌�\\x', 'E`%����<�2{[Q�'),
	(11, 'kristencooks', 'kristen', 's', '���{��3���N��C�S�1��?��G*��>9V', 'lŖx�����C�&��');
...
-- Dumping data for table recipewizard.ingredient: ~154 rows (approximately)
...
REPLACE INTO `mealhistory` (`mealHistoryId`, `recipeId`, `foodArtistId`, `tasteRatingId`, `mealMadeDate`) VALUES
	...
	(7, 8, 10, 3, '2017-01-07'),
	(8, 9, 10, 4, '2017-01-08'),
	(9, 10, 10, 4, '2017-01-09'),
	(10, 18, 10, 3, '2017-01-11'),
	(11, 13, 10, 4, '2017-01-12'),
	(12, 20, 10, 5, '2017-01-15'),
	(13, 12, 10, 4, '2017-01-17'),
	(14, 11, 10, 4, '2017-01-19'),
	(15, 16, 10, 5, '2017-01-23'),
	(16, 15, 10, 3, '2017-01-27'),
	(17, 13, 10, 4, '2017-01-30'),
	(18, 9, 10, 3, '2017-02-04'),
	(19, 23, 10, 4, '2017-02-06'),
	(20, 25, 10, 2, '2017-02-09'),
	(21, 14, 10, 4, '2017-02-12'),
	(22, 17, 10, 5, '2017-02-14'),
	(23, 10, 10, 5, '2017-02-14'),
	(24, 22, 10, 3, '2017-02-24'),
	(25, 15, 10, 3, '2017-02-26'),
	(26, 19, 10, 5, '2017-02-28'),
	(27, 13, 10, 4, '2017-03-05'),
	(28, 22, 10, 4, '2017-03-07'),
	(29, 12, 10, 4, '2017-03-09'),
	(30, 20, 10, 4, '2017-03-13'),
	(31, 24, 10, 5, '2017-03-15'),
	(32, 13, 10, 3, '2017-03-16'),
	(33, 8, 10, 4, '2017-03-19'),
	(34, 15, 10, 3, '2017-03-21'),
	(35, 2, 10, 4, '2017-03-27'),
	(36, 9, 10, 4, '2017-03-30'),
	(37, 14, 10, 3, '2017-04-02'),
	(38, 5, 10, 4, '2017-04-05'),
	(39, 11, 10, 3, '2017-04-06'),
	(40, 11, 10, 4, '2017-04-09'),
	(41, 2, 10, 4, '2017-04-12'),
	(42, 9, 10, 2, '2017-04-15'),
	(43, 5, 10, 5, '2017-04-16'),
	(44, 20, 10, 5, '2017-04-17'),
	(45, 19, 10, 5, '2017-04-19'),
	(46, 16, 10, 5, '2017-04-20'),
	(47, 20, 10, 4, '2017-04-21'),
	(48, 12, 10, 3, '2017-04-27'),
	(49, 22, 10, 4, '2017-04-29'),
	(50, 24, 10, 2, '2017-05-02'),
	(51, 2, 10, 3, '2017-05-03'),
	(52, 5, 10, 2, '2017-05-07'),
	(53, 15, 10, 3, '2017-05-08'),
	(54, 18, 10, 3, '2017-05-10'),
	(55, 10, 10, 3, '2017-05-11'),
	(56, 13, 10, 4, '2017-05-14'),
	(57, 22, 10, 4, '2017-05-17'),
	(58, 14, 10, 4, '2017-05-22'),
	(59, 25, 10, 3, '2017-05-25'),
	(60, 23, 10, 3, '2017-05-28'),
	(61, 10, 10, 4, '2017-05-31'),
	(62, 13, 10, 2, '2017-06-02'),
	(63, 12, 10, 2, '2017-06-05'),
	(64, 2, 10, 4, '2017-06-08'),
	(65, 8, 10, 4, '2017-06-11'),
	(66, 16, 10, 5, '2017-06-12'),
	(67, 25, 10, 5, '2017-06-15'),
	(68, 14, 10, 5, '2017-06-18'),
	(69, 19, 10, 5, '2017-07-04'),
	(70, 14, 10, 5, '2017-07-04'),
	(71, 2, 10, 4, '2017-07-08'),
	(72, 10, 10, 4, '2017-07-11'),
	(73, 23, 10, 3, '2017-07-15'),
	(74, 15, 10, 3, '2017-07-16'),
	(75, 22, 10, 4, '2017-07-17'),
	(76, 8, 10, 2, '2017-07-18'),
	(77, 9, 10, 4, '2017-07-19'),
	(78, 10, 10, 3, '2017-07-20'),
	(79, 9, 10, 4, '2017-07-21'),
	(80, 17, 10, 4, '2017-07-22'),
	(81, 11, 10, 3, '2017-07-23'),
	(82, 13, 10, 3, '2017-07-24'),
	(83, 14, 10, 4, '2017-07-25'),
	(84, 25, 10, 4, '2017-07-26'),
	(85, 2, 10, 4, '2017-07-27'),
	(86, 9, 10, 4, '2017-07-28'),
	(87, 22, 10, 4, '2017-07-29'),
	(88, 11, 10, 4, '2017-07-30'),
	(89, 15, 10, 4, '2017-07-31'),
	(90, 13, 10, 5, '2017-08-01'),
	(91, 23, 10, 2, '2017-08-02'),
	(92, 18, 10, 3, '2017-08-03'),
	(93, 20, 10, 5, '2017-08-04'),
	(94, 2, 10, 4, '2017-08-05'),
	(95, 13, 10, 4, '2017-08-06'),
	(96, 19, 10, 5, '2017-08-07'),
	(97, 22, 10, 4, '2017-08-08'),
	(98, 14, 10, 5, '2017-08-09'),
	(99, 2, 10, 4, '2017-08-10'),
	(100, 23, 10, 2, '2017-08-11');
...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  `difficultyratingid` int(11) NOT NULL,
  PRIMARY KEY (`recipeId`),
  KEY `difficutlyrating_recipe_fk` (`difficultyratingid`),
  KEY `foodartist_recipe_fk` (`foodArtistId`),
  KEY `recipecategory_recipe_fk` (`recipecategoryid`),
  KEY `recipecuisine_recipe_fk` (`recipecuisineid`),
  CONSTRAINT `difficutlyrating_recipe_fk` FOREIGN KEY (`difficultyratingid`) REFERENCES `difficultyrating` (`difficultyratingId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tasterating` (
  `tasteRatingId` int(11) NOT NULL,
  `tasteRatingName` varchar(50) NOT NULL,
  `tasteRatingSortOrder` int(11) NOT NULL,
  PRIMARY KEY (`tasteRatingId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table recipewizard.tasterating: ~5 rows (approximately)
/*!40000 ALTER TABLE `tasterating` DISABLE KEYS */;
REPLACE INTO `tasterating` (`tasteRatingId`, `tasteRatingName`, `tasteRatingSortOrder`) VALUES
	(1, 'Meh', 1),
	(2, 'Fair', 2),
	(3, 'Tempting', 3),
	(4, 'Heavenly', 4),
